...
class CoreServiceProvider extends BaseServiceProvider
{
    ...
    protected function views()
    {
        ...
        $this->registerGlobalBladeDirectives();
    ...
    protected function registerGlobalBladeDirectives()
    {
    ...
    protected function registerAdminBladeDirectives()
    {
    ...
    protected function registerFormComponents()
    {
        ...
        Form::component(
            'videoUploader',
            'cms-core::admin.components.video-uploader',
