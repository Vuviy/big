...
use WezomCms\Core\Files\VideoService;
...
trait FileAttachable
{
     ...
     * @return array|null
     */
    public function getRecommendUploadVideoResolution(string $field = VideoService::VIDEO): ?array
    {
        return app(VideoService::class)->getRecommendUploadVideoResolution($this, $field);
    }
     ...
     * @return array|null
     */
    public function getRecommendUploadVideoMaxFileSize(string $field = VideoService::VIDEO): ?string
    {
        return app(VideoService::class)->getRecommendUploadVideoMaxFileSize($this, $field);
    }
}
