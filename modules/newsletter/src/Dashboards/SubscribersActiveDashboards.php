...
class SubscribersActiveDashboards extends AbstractValueDashboard
{
    /**
    ...
    {
        return __('cms-newsletter::admin.Subscribers active');
    }
    ...
    {
        return route('admin.subscribers.index', ['active' => 1]);
    }
}
